...
import { Briefcase, Award, ExternalLink, MapPin, TrendingUp, Users, Calendar, Megaphone, ShieldCheck, HeartHandshake, Sparkles, Crown, Palette, Globe, Rocket, Terminal, Flag, CheckCircle2, Image as ImageIcon, ArrowUp, ArrowRight } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#060913] text-gray-100 font-sans selection:bg-[#e0231c] selection:text-white relative overflow-x-hidden">

      {/* Top Navbar */}
      <nav className="bg-[#060913]/90 backdrop-blur-md border-b border-gray-800/60 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <span className="w-3 h-3 bg-[#e0231c] rounded-full shadow-[0_0_12px_#e0231c]"></span>
            <span className="font-bold text-xl tracking-wider text-white font-sans">Faysal</span>
          </div>
          ...
          <div>
            <a href="#contact" className="bg-[#111827] hover:bg-[#e0231c] border border-gray-800 hover:border-[#e0231c] text-white px-5 py-2 rounded-full text-xs font-bold transition shadow-sm">
              Hire Me
            </a>
          </div>
        </div>
      ...
      {/* 3D Interactive Kage Shader Hero Section */}
      ...
      {/* Kage Theme Bio Header Section */}
      <section className="relative pt-12 pb-16 md:py-20 px-6 max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12 overflow-hidden border-b border-gray-800/60">
        {/* Background Ambient Crimson Glow Orbs */}
        <div className="absolute top-10 left-1/4 w-96 h-96 bg-[#e0231c]/10 rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-rose-600/10 rounded-full blur-[100px] pointer-events-none"></div>

        {/* Left Column: Bio & Calls to Action */}
        <div className="space-y-6 text-center md:text-left flex-1 relative z-10">
          
          {/* Status Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#e0231c]/10 border border-[#e0231c]/25 text-[#ff4d4d] text-xs font-semibold tracking-wide">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
              Hi, I'm <span className="bg-gradient-to-r from-red-500 via-rose-400 to-[#e0231c] bg-clip-text text-transparent">Faysal Ibne Safir</span> Shanto
            </h1>
            <p className="text-[#ff4d4d] font-bold text-lg sm:text-xl md:text-2xl tracking-wide flex items-center justify-center md:justify-start gap-2">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start pt-2">
            <a href="#skills" className="bg-[#e0231c] hover:bg-[#ff3b34] text-white px-7 py-3.5 rounded-xl font-bold transition text-sm shadow-[0_0_25px_rgba(224,35,28,0.4)] flex items-center gap-2">
            ...
            <Link href="/blog" className="bg-[#0d1322]/80 hover:bg-[#e0231c]/20 border border-[#e0231c]/30 text-[#ff4d4d] hover:text-white px-5 py-3.5 rounded-xl font-bold transition text-sm flex items-center gap-1.5">
              Read Blog →
            </Link>
          </div>
          ...
          <div className="flex gap-3 justify-center md:justify-start pt-3 items-center">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/faysal-ibne-safir-shanto/" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322] border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-[#ff4d4d] rounded-xl transition shadow-md flex items-center justify-center group" aria-label="LinkedIn">
            ...
            {/* GitHub */}
            <a href="https://github.com/faysalshanto" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322] border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-white rounded-xl transition shadow-md flex items-center justify-center group" aria-label="GitHub">
              <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/faysal.ibne.safir.shanto" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322] border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-blue-500 rounded-xl transition shadow-md flex items-center justify-center group" aria-label="Facebook">
              <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/faysal_shanto_16/" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322] border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-pink-400 rounded-xl transition shadow-md flex items-center justify-center group" aria-label="Instagram">
              <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
        ...
        {/* Right Column: Profile Image with Kage Crimson Glow & Floating Badge */}
        <div className="relative flex justify-center items-center">
          {/* Glowing Crimson Aura Ring */}
          <div className="absolute -inset-1.5 bg-gradient-to-r from-[#e0231c] to-rose-600 rounded-3xl blur-xl opacity-40 group-hover:opacity-70 transition duration-500"></div>

          <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-[#0d1322] rounded-3xl border-2 border-[#e0231c]/40 shadow-[0_0_40px_rgba(224,35,28,0.25)] overflow-hidden relative group cursor-pointer transition-all duration-500 hover:border-[#e0231c] hover:shadow-[0_0_50px_rgba(224,35,28,0.5)]">
            <img
              src="/profile.jpg"
          ...
          {/* Floating Pill Badge */}
          <div className="absolute -bottom-4 right-2 sm:right-6 bg-[#0d1322]/90 backdrop-blur-md border border-[#e0231c]/30 px-4 py-2 rounded-2xl shadow-xl flex items-center gap-2.5">
            <div className="p-1.5 bg-[#e0231c]/20 rounded-xl text-[#ff4d4d]">
              <Rocket size={16} />
            </div>
            <div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-28">
        ...
        <section id="about" className="space-y-6">
          <div className="text-center">
            <div className="inline-flex flex-col items-center">
              ...
              <div className="w-[25%] h-0.5 bg-[#e0231c] mx-auto rounded-full"></div>
            </div>
          </div>
          <div className="bg-[#0d1322] border border-gray-800/80 p-8 md:p-10 rounded-3xl shadow-lg space-y-4 text-gray-300 leading-relaxed text-sm md:text-base whitespace-pre-line text-center md:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-6 border-t border-gray-800/80">
              <div className="text-center"><h3 className="text-2xl font-black text-[#ff4d4d]">3+</h3><p className="text-xs text-gray-400 mt-1">Years Experience</p></div>
              <div className="text-center"><h3 className="text-2xl font-black text-rose-400">10+</h3><p className="text-xs text-gray-400 mt-1">Campaigns Handled</p></div>
              <div className="text-center"><h3 className="text-2xl font-black text-amber-400">Maglyn</h3><p className="text-xs text-gray-400 mt-1">Startup Founder</p></div>
              <div className="text-center"><h3 className="text-2xl font-black text-[#ff4d4d]">BUBT</h3><p className="text-xs text-gray-400 mt-1">BBA Student</p></div>
            </div>
          </div>
        </section>
        ...
        <section id="skills" className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: "Digital Marketing", pct: "90%", icon: <TrendingUp size={22} className="text-[#ff4d4d]" /> },
              { name: "Graphic & Content Design", pct: "95%", icon: <Palette size={22} className="text-pink-400" /> },
              { name: "Social Media Strategy", pct: "85%", icon: <Megaphone size={22} className="text-rose-400" /> },
              { name: "Community Building", pct: "95%", icon: <Users size={22} className="text-amber-400" /> },
              { name: "Event Management", pct: "88%", icon: <Calendar size={22} className="text-[#ff4d4d]" /> },
              ...
              <div key={i} className="bg-[#0d1322] border border-gray-800 p-5 rounded-2xl flex flex-col justify-between hover:border-[#e0231c]/50 transition">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-gray-900 border border-gray-800 rounded-xl">
                    {skill.icon}
                  </div>
                  <span className="text-xs font-mono bg-[#e0231c]/10 text-[#ff4d4d] border border-[#e0231c]/20 px-2.5 py-1 rounded-full">{skill.pct}</span>
                </div>
                <div className="space-y-2">
                  <span className="text-sm font-bold text-white block">{skill.name}</span>
                  <div className="w-full bg-gray-900 h-2 rounded-full overflow-hidden">
                    <div className="bg-gradient-to-r from-[#e0231c] to-rose-500 h-full rounded-full" style={{ width: skill.pct }}></div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section id="experience" className="space-y-6">
          ...
          <div className="space-y-4">
            {[
              { role: "Sales Growth Business Partner", org: "Flowmingo AI", date: "Jun 2026 - Present", desc: "Driving adoption of AI-native interview platforms and sales growth strategies across regions.", icon: <Rocket className="text-[#ff4d4d]" size={18} /> },
              { role: "Social Media & Marketing Intern", org: "Elevetr AI", date: "Jun 2026 - Dec 2026", desc: "Managing user growth strategies, digital marketing campaigns, and community engagement.", icon: <TrendingUp className="text-rose-400" size={18} /> },
              { role: "Core Campus Ambassador Manager", org: "10 Minute School", date: "Aug 2022 - Present", desc: "Managed ambassador networks nationwide, driving student acquisition and product awareness.", icon: <Users className="text-[#ff4d4d]" size={18} /> },
              ...
              <div key={i} className="bg-[#0d1322] border border-gray-800 p-6 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:border-gray-700 transition">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#ff4d4d] font-semibold">{exp.org}</p>
        ...
        <section id="leadership" className="space-y-6">
          ...
          <div className="space-y-4">
            {[
              { role: "Executive Member", org: "AI Community BUBT", date: "2025 – Present", desc: "Involved in BAIC 2025, AI-focused workshops, competitions, and community activities. Worked as part of the organizing team and was also a member of Team Elite, the Champion of the Pitch Battle.", icon: <Sparkles className="text-rose-400" size={18} /> },
              ...
              <div key={i} className="bg-[#0d1322] border border-gray-800 p-6 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:border-gray-700 transition">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#ff4d4d] font-semibold">{lead.org}</p>
        ...
        <section id="portfolio" className="space-y-8">
          <div className="text-center">
            <div className="inline-flex flex-col items-center">
              ...
              <div className="w-[25%] h-0.5 bg-[#e0231c] mx-auto rounded-full mb-3"></div>
            </div>
            <p className="text-xs font-mono tracking-widest text-[#ff4d4d] uppercase">Maglyn Startup & Creative Work</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">

            {/* Startup Card: Maglyn */}
            <div className="bg-[#0d1322] border-2 border-[#e0231c]/40 p-8 rounded-3xl shadow-xl relative overflow-hidden flex flex-col justify-between group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#e0231c]/10 rounded-full blur-3xl pointer-events-none"></div>
              <div className="space-y-4">
                <span className="text-[10px] font-extrabold uppercase tracking-widest bg-[#e0231c]/20 text-[#ff4d4d] border border-[#e0231c]/30 px-3 py-1 rounded-full inline-block">My Startup</span>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <div className="aspect-square bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden group-hover:border-[#e0231c]/50 transition">
                    <img
                      src="/maglyn-1.jpg"
              ...
              <div className="flex gap-3 pt-6 border-t border-gray-800/80">
                <a href="https://www.facebook.com/maglyn.official/" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 bg-[#e0231c] hover:bg-[#ff3b34] text-white rounded-xl text-xs font-bold transition shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                {[
                  ...
                  <div key={idx} className="bg-gray-900/60 border border-gray-800/80 p-3.5 rounded-xl space-y-1 hover:border-gray-700 transition">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-[#ff4d4d]">
        ...
        <section className="space-y-6">
          ...
          <div className="flex justify-end -mt-2 mb-2">
            <Link href="/blog" className="text-sm font-bold text-[#ff4d4d] hover:underline">View All Posts →</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {posts.map((post) => (
              <Link href={`/blog/${post.slug}`} key={post.id} className="bg-[#0d1322] border border-gray-800 p-6 rounded-2xl hover:border-[#e0231c]/50 transition group">
                <p className="text-xs text-[#ff4d4d] font-bold uppercase mb-2">{post.date} • {post.category}</p>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#ff4d4d] transition">{post.title}</h3>
                <p className="text-sm text-gray-400 mb-4 line-clamp-2">{post.excerpt}</p>
                <span className="text-sm font-bold text-[#ff4d4d] group-hover:underline">Read Article »</span>
              </Link>
            ))}
          </div>
        </section>
            ...
            <div className="bg-[#0d1322] border border-gray-800 p-8 rounded-3xl space-y-6">
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Message sent successfully!"); }}>
                <div className="grid grid-cols-2 gap-4">
                  <input type="text" placeholder="First Name" className="w-full px-4 py-3 bg-[#060913] border border-gray-800 rounded-xl text-sm text-gray-200 focus:outline-none focus:border-[#e0231c]" required />
                  <input type="text" placeholder="Last Name" className="w-full px-4 py-3 bg-[#060913] border border-gray-800 rounded-xl text-sm text-gray-200 focus:outline-none focus:border-[#e0231c]" required />
                </div>
                <input type="email" placeholder="Email Address" className="w-full px-4 py-3 bg-[#060913] border border-gray-800 rounded-xl text-sm text-gray-200 focus:outline-none focus:border-[#e0231c]" required />
                <textarea placeholder="Your Message" rows={4} className="w-full px-4 py-3 bg-[#060913] border border-gray-800 rounded-xl text-sm text-gray-200 focus:outline-none focus:border-[#e0231c]" required></textarea>
                <button type="submit" className="w-full bg-[#e0231c] hover:bg-[#ff3b34] text-white font-bold py-3 rounded-xl transition text-sm shadow-[0_0_15px_rgba(224,35,28,0.3)] cursor-pointer">
                  Submit Message 🚀
                </button>
              </form>
            </div>
            ...
            <div className="bg-[#0d1322] border border-gray-800 p-8 rounded-3xl flex flex-col justify-between space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                  <MapPin className="text-[#ff4d4d]" size={20} /> Location & Info
                </h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  Bangladesh University of Business and Technology (BUBT), Rupnagar, Mirpur-2, Dhaka-1216.
                </p>
                <p className="text-xs text-[#ff4d4d] font-mono">Email: faysal.shanto.official@gmail.com</p>
              </div>
      ...
      <button onClick={scrollToTop} className="fixed bottom-6 right-6 p-3.5 bg-[#e0231c] hover:bg-[#ff3b34] text-white rounded-2xl shadow-[0_0_20px_rgba(224,35,28,0.4)] transition z-50 flex items-center justify-center group cursor-pointer" aria-label="Scroll to top">
