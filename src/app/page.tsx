...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#060913] text-gray-100 font-sans selection:bg-blue-600 selection:text-white relative overflow-x-hidden">
      ...
      <section className="bg-gradient-to-b from-[#060913] via-[#0d1322]/80 to-[#060913] py-16 px-6 border-b border-gray-800/60">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white">Maglyn Magazine Collection</h2>
            <p className="text-gray-400 text-sm md:text-base max-w-xl mx-auto">
              A premium personalized magazine-printing brand transforming life's stories into physical keepsake magazines.
            </p>
          </div>
        ...
        <section id="about" className="space-y-6">
          ...
          <div className="bg-[#0d1322] border border-gray-800/80 p-8 md:p-10 rounded-3xl shadow-lg space-y-4 text-gray-300 leading-relaxed text-sm md:text-base whitespace-pre-line text-center md:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-6 border-t border-gray-800/80">
              ...
              <div className="text-center"><h3 className="text-2xl font-black text-indigo-400">10+</h3><p className="text-xs text-gray-400 mt-1">Campaigns Handled</p></div>
              <div className="text-center"><h3 className="text-2xl font-black text-purple-400">Maglyn</h3><p className="text-xs text-gray-400 mt-1">Startup Founder</p></div>
            ...
            {[
              ...
              <div key={i} className="bg-[#0d1322] border border-gray-800 p-5 rounded-2xl flex flex-col justify-between hover:border-blue-500/50 transition">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-xs font-mono bg-blue-500/10 text-blue-400 border border-blue-500/20 px-2.5 py-1 rounded-full">{skill.pct}</span>
                </div>
        ...
        <section id="portfolio" className="space-y-8">
          <div className="text-center">
            <div className="inline-flex flex-col items-center">
              ...
              <div className="w-[25%] h-0.5 bg-blue-600 mx-auto rounded-full mb-3 shadow-[0_0_8px_#2563eb]"></div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[#0d1322] border-2 border-blue-500/40 p-8 rounded-3xl shadow-xl relative overflow-hidden flex flex-col justify-between group">
              ...
              <div className="flex gap-3 pt-6 border-t border-gray-800/80">
                <a href="https://www.facebook.com/maglyn.official/" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold transition shadow-sm">
      ...
      <button onClick={scrollToTop} className="fixed bottom-6 right-6 p-3.5 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl shadow-[0_0_20px_rgba(37,99,235,0.4)] transition z-50 flex items-center justify-center group cursor-pointer" aria-label="Scroll to top">
