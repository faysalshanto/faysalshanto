...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#060913] text-gray-100 font-sans selection:bg-blue-600 selection:text-white relative overflow-x-hidden">
      ...
      {/* Stunning Native Dark-Themed Hero Section */}
      <section className="relative pt-12 pb-20 md:py-24 px-6 max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12 overflow-hidden border-b border-gray-800/60">
        ...
        <div className="space-y-6 text-center md:text-left flex-1 relative z-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-blue-400 font-bold text-xl md:text-2xl tracking-wide flex items-center justify-center md:justify-start gap-2">
              <Sparkles size={20} className="text-amber-400" /> Digital Marketer & Startup Founder
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start pt-2">
            <a href="#skills" className="bg-blue-600 hover:bg-blue-500 text-white px-7 py-3.5 rounded-xl font-bold transition text-sm shadow-[0_0_25px_rgba(37,99,235,0.4)] flex items-center gap-2">
              Explore Skills <ArrowRight size={16} />
            </a>
            <a href="#contact" className="bg-[#111827] hover:bg-gray-800 border border-gray-800 hover:border-gray-700 text-gray-200 px-7 py-3.5 rounded-xl font-bold transition text-sm">
              Contact Me
            </a>
            <Link href="/blog" className="bg-[#111827]/80 hover:bg-blue-600/20 border border-blue-500/30 text-blue-400 hover:text-white px-5 py-3.5 rounded-xl font-bold transition text-sm flex items-center gap-1.5">
              Read Blog →
            </Link>
          </div>
          ...
          <div className="flex gap-3 justify-center md:justify-start pt-3 items-center">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/faysal_shanto_16/" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322] border border-gray-800 hover:border-pink-500 text-gray-300 hover:text-pink-400 rounded-xl transition shadow-md flex items-center justify-center group" aria-label="Instagram">
              <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
        ...
        {/* Right Column: Profile Image with Glow & Floating Badge */}
        <div className="relative flex justify-center items-center">
          {/* Glowing Aura Ring */}
          <div className="absolute -inset-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl blur-xl opacity-40 group-hover:opacity-70 transition duration-500"></div>

          <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-[#0d1322] rounded-3xl border-2 border-blue-500/40 shadow-[0_0_40px_rgba(37,99,235,0.2)] overflow-hidden relative group cursor-pointer transition-all duration-500 hover:border-blue-400 hover:shadow-[0_0_50px_rgba(37,99,235,0.5)]">
            <img
              src="/profile.jpg"
          ...
          {/* Floating Pill Badge */}
          <div className="absolute -bottom-4 right-2 sm:right-6 bg-[#0d1322]/90 backdrop-blur-md border border-blue-500/30 px-4 py-2 rounded-2xl shadow-xl flex items-center gap-2.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#0d1322] border border-gray-800 p-8 rounded-3xl space-y-6">
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Message sent successfully!"); }}>
                ...
                <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl transition text-sm shadow-[0_0_15px_rgba(37,99,235,0.3)] cursor-pointer">
                  Submit Message 🚀
                </button>
              </form>
            </div>
