...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#060913] text-gray-100 font-sans selection:bg-[#e0231c] selection:text-white relative overflow-x-hidden">
      ...
      {/* Unified Masterclass Hero Header with Integrated Interactive Kage 3D Shader Background */}
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden border-b border-gray-800/60">
        
        {/* Background 3D Interactive Kage Canvas */}
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#e0231c]/15 rounded-full blur-[140px] pointer-events-none z-[1]"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-rose-600/10 rounded-full blur-[140px] pointer-events-none z-[1]"></div>

        {/* Hero Content Layer Overlaid on Top of 3D Canvas */}
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24 flex flex-col-reverse md:flex-row items-center justify-between gap-12 w-full">
          ...
          <div className="space-y-6 text-center md:text-left flex-1">
            ...
            {/* Status Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0d1322]/90 border border-[#e0231c]/30 text-[#ff4d4d] text-xs font-semibold tracking-wide backdrop-blur-md shadow-lg">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start pt-2">
              <a href="#skills" className="bg-[#e0231c] hover:bg-[#ff3b34] text-white px-7 py-3.5 rounded-xl font-bold transition text-sm shadow-[0_0_30px_rgba(224,35,28,0.4)] flex items-center gap-2 cursor-pointer">
              ...
              <Link href="/blog" className="bg-[#0d1322]/90 backdrop-blur-md hover:bg-[#e0231c]/20 border border-[#e0231c]/30 text-[#ff4d4d] hover:text-white px-5 py-3.5 rounded-xl font-bold transition text-sm flex items-center gap-1.5">
                Read Blog →
              </Link>
            </div>
            ...
            <div className="flex gap-3 justify-center md:justify-start pt-3 items-center">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/faysal-ibne-safir-shanto/" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322]/90 border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-[#ff4d4d] rounded-xl transition shadow-md flex items-center justify-center group" aria-label="LinkedIn">
              ...
              {/* GitHub */}
              <a href="https://github.com/faysalshanto" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322]/90 border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-white rounded-xl transition shadow-md flex items-center justify-center group" aria-label="GitHub">
                <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/faysal.ibne.safir.shanto" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322]/90 border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-blue-500 rounded-xl transition shadow-md flex items-center justify-center group" aria-label="Facebook">
                <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/faysal_shanto_16/" target="_blank" rel="noreferrer" className="p-3 bg-[#0d1322]/90 border border-gray-800 hover:border-[#e0231c] text-gray-300 hover:text-pink-400 rounded-xl transition shadow-md flex items-center justify-center group" aria-label="Instagram">
                <svg className="w-5 h-5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
          ...
          <div className="relative flex justify-center items-center">
            ...
            <div className="absolute -inset-1.5 bg-gradient-to-r from-[#e0231c] to-rose-600 rounded-3xl blur-xl opacity-50 group-hover:opacity-80 transition duration-500"></div>

            <div className="w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-[#0d1322] rounded-3xl border-2 border-[#e0231c]/50 shadow-[0_0_50px_rgba(224,35,28,0.3)] overflow-hidden relative group cursor-pointer transition-all duration-500 hover:border-[#e0231c] hover:shadow-[0_0_60px_rgba(224,35,28,0.6)]">
              <img
                src="/profile.jpg"
            ...
            {/* Floating Pill Badge */}
            <div className="absolute -bottom-4 right-2 sm:right-6 bg-[#0d1322]/95 backdrop-blur-md border border-[#e0231c]/40 px-4 py-2.5 rounded-2xl shadow-2xl flex items-center gap-2.5">
        ...
        <section id="about" className="space-y-6">
          <div className="text-center">
            <div className="inline-flex flex-col items-center">
              ...
              <div className="w-[25%] h-0.5 bg-[#e0231c] mx-auto rounded-full shadow-[0_0_8px_#e0231c]"></div>
            </div>
          </div>
        ...
        <section id="portfolio" className="space-y-8">
          <div className="text-center">
            <div className="inline-flex flex-col items-center">
              ...
              <div className="w-[25%] h-0.5 bg-[#e0231c] mx-auto rounded-full mb-3 shadow-[0_0_8px_#e0231c]"></div>
            </div>
