        ...
        <section id="leadership" className="space-y-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { role: "Media & Publication Secretary", org: "BUBT Business Club (BUBTBC)", date: "2024 – Present", desc: "Involved in various business, career, networking, and student engagement events organized by the club, contributing to media, publication, and promotional activities.", icon: <Palette className="text-pink-400" size={18} /> },
              { role: "Volunteer", org: "BASIS Students’ Forum", date: "2025", desc: "Volunteered at the ICPC Asia Dhaka Regional Contest 2025 and participated in various technology-focused programs and student activities.", icon: <Terminal className="text-emerald-400" size={18} /> },
              { role: "Treasurer", org: "Leo Club of Dhaka Century Plus", date: "2024 – Present", desc: "Currently involved in various community service, awareness, and social welfare initiatives, including a Women’s Reproductive Health & Infertility Awareness Seminar.", icon: <HeartHandshake className="text-red-400" size={18} /> },
              { role: "Crew Facilitator", org: "Space Innovation Camp", date: "2024 – Present", desc: "Currently working as a Crew Facilitator at Space Innovation Camp, involved in participant management, crew coordination, activity facilitation, and overall event execution.", icon: <Globe className="text-purple-400" size={18} /> },
